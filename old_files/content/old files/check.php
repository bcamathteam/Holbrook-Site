...
?>
  <h2 class="txt">
	BCA Math Competition 2011
	</h2>
<h3 class="txt">Payment via Check </h3>
<p class="info">Please write a check for <b>$30.00</b> made out to <b>Student Activity Fund - Math Competition</b>.<br>

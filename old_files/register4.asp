...
<p class="info">All fields are required.  Have your payment information ready(credit card) before proceeding. Payment is done through Paypal. The registration fee is non-refundable</p>
...
<form method="post" action="doreg.php" onSubmit="return Validate(first_name, last_name, home_addr, home_city, home_zip, school, email, phone)">
  <table class="info">
    <tr>
      <td class="name" width="250" id="name">First &amp; Last Name</td>
      <td width="450">&nbsp;
    ...
    <tr>
      ...
      <td>&nbsp;
          <% Call MakeDateWithValidation("birth_year", "birth_month", "birth_day", 1998, 2007, "--", "--", False, True, 7) %></td>
    </tr>
	 <tr>
	 	<td class="name" id="grade">Grade</td>
		<td>&nbsp; <b>(In October 2014)</b>
